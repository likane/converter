          ...
          case "Atomic Mass Unit":
            switch (endUnit) {
              ...
              case "Metric Ton":
                ...
                this.setState({
                  toValue:
                    startValue * 0.000000000000000000000000000001660540199
                });
                break;
              case "Long Ton":
                //Kilometer to nanooKilometer
                this.setState({
                  toValue:
                    startValue * 0.000000000000000000000000000001634315837
                });
                break;
              case "Short Ton":
                //Kilometer to mile
                this.setState({
                  toValue:
                    startValue * 0.000000000000000000000000000001830433737
                });
                break;
              case "Pound":
                //Kilometer to Yard
